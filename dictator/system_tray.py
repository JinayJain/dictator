...
class SystemTrayManager:
    ...
    def start(self) -> None:
        ...
        self.icon = pystray.Icon("dictator", icon_image, "Dictator - Voice Transcription", menu)
    ...
    def _create_idle_icon(self) -> Image.Image:
        ...
        draw.ellipse([margin, margin, size - margin, size - margin], 
                    fill=(128, 128, 128, 255), outline=(64, 64, 64, 255), width=2)
    ...
    def _create_recording_icon(self) -> Image.Image:
        ...
        margin = 8
        draw.ellipse([margin, margin, size - margin, size - margin], 
                    fill=(220, 20, 20, 255), outline=(180, 0, 0, 255), width=2)
    ...
    def _create_transcribing_icon(self) -> Image.Image:
        ...
        margin = 8
        draw.ellipse([margin, margin, size - margin, size - margin], 
                    fill=(20, 120, 220, 255), outline=(0, 80, 180, 255), width=2)
